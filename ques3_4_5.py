...
sweep_id = wandb.sweep(sweep_config, project="DA6401-Assignment1")  #sweep_id is linked to the project name
...
# Run W&B Sweep Agent
# -------------------------------
wandb.agent("czmtxmrk", run_experiment, project="DA6401-Assignment1", count=30)
